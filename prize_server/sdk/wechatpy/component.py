...
import xmltodict
from sdk.wechatpy import MemoryStorage
from sdk.wechatpy import MessageMetaClass
from sdk.wechatpy import StringField, DateTimeField
from sdk.wechatpy import WeChatClientException, APILimitedException
from sdk.wechatpy import WeChatComponentClient
from sdk.wechatpy import WeChatCrypto
from sdk.wechatpy import to_text, to_binary, get_querystring, json
...
class BaseWeChatComponent(object):
    ...
    def __init__(self,
        ...
        if isinstance(session, six.string_types):
            ...
            from sdk.wechatpy import ShoveStorage
