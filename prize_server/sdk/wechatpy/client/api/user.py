...
class WeChatUser(BaseWeChatAPI):
    ...
    def get(self, user_id, lang='zh_CN'):
        ...
        使用示例::
            ...
            client = client.client.get('openid')
    ...
    def get_followers(self, first_user_id=None):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            followers = client.client.get_followers()
    ...
    def update_remark(self, user_id, remark):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            client.client.update_remark('openid', 'Remark')

        """
        return self._post(
            'client/info/updateremark',
            data={
                'openid': user_id,
                'remark': remark
            }
    ...
    def get_group_id(self, user_id):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            group_id = client.client.get_group_id('openid')
    ...
    def get_batch(self, user_list):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            users = client.client.get_batch(['openid1', 'openid2'])
            users = client.client.get_batch([
