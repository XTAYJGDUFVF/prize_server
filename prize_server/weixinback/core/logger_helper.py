...
def init_logger(logger_name):
    if logger_name not in Logger.manager.loggerDict:
        ...
        try:
            ...
            handler1 = TimedRotatingFileHandler(r'F:\11.5晚上\git文件管理\prize_server\weixinback\core\log\all.log', when='D', interval=1, backupCount=7)
        ...
        try:
            ...
            handler2 = TimedRotatingFileHandler(r'F:\11.5晚上\git文件管理\prize_server\weixinback\core\log\error.log', when='D', interval=1, backupCount=7)
